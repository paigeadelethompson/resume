...
function _getGitVersion() {
  _getGitVersion = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var output, match;
...
function _readJson() {
  _readJson = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(path) {
