...
function _fetchCommits() {
  _fetchCommits = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(remote, options) {
    var branch,
        onProgress,
        command,
        format,
...
function _getLogFormat() {
  _getLogFormat = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
...
function getTag(refs, options) {
  ...
  var _iterator = _createForOfIteratorHelper(refs.split(', ')),
      _step;
