...
if os.path.isfile(FONT) and subprocess.check_output(['otfinfo', '-v', FONT], universal_newlines=True).split()[1] == VERSION:
  ...
  print("Downloading the font and css...");
  try:
  ...
  print("Converting the font to 1000 upm...");
...
# ------------------------------------------------------------------------------
print("Identifying glyphs from css...");
css_file = open(CSS, 'r');
css = css_file.read();
css_file.close();
...
# ------------------------------------------------------------------------------
print("Generating the generic symbol list...");
...
# ------------------------------------------------------------------------------
print("Generating the xe-/luatex symbol list...");
...
# ------------------------------------------------------------------------------
print("Generating the pdftex symbol list...");
try:
